...
public class OrderCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -909809269770112052L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderCreatedEvent\",\"namespace\":\"com.product.service.coreapi.events.order\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"},\"doc\":\"Unique identifier for the order\"},{\"name\":\"products\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"OrderProductState\",\"fields\":[{\"name\":\"productId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"description\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"price\",\"type\":\"double\"},{\"name\":\"sellerId\",\"type\":\"long\"},{\"name\":\"quantity\",\"type\":\"long\"},{\"name\":\"categoryId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"inventoryCount\",\"type\":\"int\"},{\"name\":\"createdAt\",\"type\":[\"null\",{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}],\"default\":null},{\"name\":\"updatedAt\",\"type\":[\"null\",{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}],\"default\":null},{\"name\":\"deletedAt\",\"type\":[\"null\",{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}],\"default\":null}]}}},{\"name\":\"payment_method\",\"type\":\"long\",\"doc\":\"Payment method used for the order\"},{\"name\":\"total_price\",\"type\":\"double\",\"doc\":\"Total price of the order\"},{\"name\":\"created_at\",\"type\":[\"null\",{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}],\"doc\":\"Date the order was created\"},{\"name\":\"updated_at\",\"type\":[\"null\",{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}],\"doc\":\"Date the order was last updated\",\"default\":null},{\"name\":\"buyer_id\",\"type\":\"long\",\"doc\":\"ID of the buyer\"},{\"name\":\"status\",\"type\":{\"type\":\"enum\",\"name\":\"OrderStatus\",\"symbols\":[\"pending\",\"approved\",\"canceled\",\"shipped\",\"delivered\"]}},{\"name\":\"weight\",\"type\":\"double\",\"doc\":\"Weight of the order\"}],\"version\":\"1\"}");
  ...
  private java.util.List<com.product.service.coreapi.events.order.OrderProductState> products;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: products = (java.util.List<com.product.service.coreapi.events.order.OrderProductState>)value$; break;
    ...
    case 6: buyer_id = (java.lang.Long)value$; break;
   ...
   */
  public java.util.List<com.product.service.coreapi.events.order.OrderProductState> getProducts() {
    return products;
  }
   ...
   * @param value the value to set.
   */
  public void setProducts(java.util.List<com.product.service.coreapi.events.order.OrderProductState> value) {
    this.products = value;
  }
   ...
   */
  public com.product.service.coreapi.events.order.OrderStatus getStatus() {
    return status;
  }
   ...
   * @param value the value to set.
   */
  public void setStatus(com.product.service.coreapi.events.order.OrderStatus value) {
    this.status = value;
  }
   ...
   */
  public static com.product.service.coreapi.events.order.OrderCreatedEvent.Builder newBuilder() {
    return new com.product.service.coreapi.events.order.OrderCreatedEvent.Builder();
  }
   ...
   * @return A new OrderCreatedEvent RecordBuilder
   */
  public static com.product.service.coreapi.events.order.OrderCreatedEvent.Builder newBuilder(com.product.service.coreapi.events.order.OrderCreatedEvent.Builder other) {
    if (other == null) {
      return new com.product.service.coreapi.events.order.OrderCreatedEvent.Builder();
    } else {
      return new com.product.service.coreapi.events.order.OrderCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderCreatedEvent RecordBuilder
   */
  public static com.product.service.coreapi.events.order.OrderCreatedEvent.Builder newBuilder(com.product.service.coreapi.events.order.OrderCreatedEvent other) {
    if (other == null) {
      return new com.product.service.coreapi.events.order.OrderCreatedEvent.Builder();
    } else {
      return new com.product.service.coreapi.events.order.OrderCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.product.service.coreapi.events.order.OrderCreatedEvent.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[6], other.buyer_id)) {
        this.buyer_id = data().deepCopy(fields()[6].schema(), other.buyer_id);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.product.service.coreapi.events.order.OrderCreatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.product.service.coreapi.events.order.OrderCreatedEvent.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.product.service.coreapi.events.order.OrderCreatedEvent.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.product.service.coreapi.events.order.OrderCreatedEvent.Builder setProducts(java.util.List<com.product.service.coreapi.events.order.OrderProductState> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.product.service.coreapi.events.order.OrderCreatedEvent.Builder clearProducts() {
      products = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.product.service.coreapi.events.order.OrderCreatedEvent.Builder setPaymentMethod(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.product.service.coreapi.events.order.OrderCreatedEvent.Builder clearPaymentMethod() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.product.service.coreapi.events.order.OrderCreatedEvent.Builder setTotalPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.product.service.coreapi.events.order.OrderCreatedEvent.Builder clearTotalPrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.product.service.coreapi.events.order.OrderCreatedEvent.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.product.service.coreapi.events.order.OrderCreatedEvent.Builder clearCreatedAt() {
      created_at = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.product.service.coreapi.events.order.OrderCreatedEvent.Builder setUpdatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.product.service.coreapi.events.order.OrderCreatedEvent.Builder clearUpdatedAt() {
      updated_at = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.product.service.coreapi.events.order.OrderCreatedEvent.Builder setBuyerId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.product.service.coreapi.events.order.OrderCreatedEvent.Builder clearBuyerId() {
    ...
    public OrderCreatedEvent build() {
      try {
        ...
        record.products = fieldSetFlags()[1] ? this.products : (java.util.List<com.product.service.coreapi.events.order.OrderProductState>) defaultValue(fields()[1]);
        ...
        record.buyer_id = fieldSetFlags()[6] ? this.buyer_id : (java.lang.Long) defaultValue(fields()[6]);
