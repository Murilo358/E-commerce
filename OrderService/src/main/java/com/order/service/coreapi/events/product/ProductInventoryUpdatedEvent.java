...
public class ProductInventoryUpdatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4616639228703404696L;
   ...
   */
  public static com.order.service.coreapi.events.product.ProductInventoryUpdatedEvent.Builder newBuilder() {
    return new com.order.service.coreapi.events.product.ProductInventoryUpdatedEvent.Builder();
  }
   ...
   * @return A new ProductInventoryUpdatedEvent RecordBuilder
   */
  public static com.order.service.coreapi.events.product.ProductInventoryUpdatedEvent.Builder newBuilder(com.order.service.coreapi.events.product.ProductInventoryUpdatedEvent.Builder other) {
    if (other == null) {
      return new com.order.service.coreapi.events.product.ProductInventoryUpdatedEvent.Builder();
    } else {
      return new com.order.service.coreapi.events.product.ProductInventoryUpdatedEvent.Builder(other);
    }
  }
   ...
   * @return A new ProductInventoryUpdatedEvent RecordBuilder
   */
  public static com.order.service.coreapi.events.product.ProductInventoryUpdatedEvent.Builder newBuilder(com.order.service.coreapi.events.product.ProductInventoryUpdatedEvent other) {
    if (other == null) {
      return new com.order.service.coreapi.events.product.ProductInventoryUpdatedEvent.Builder();
    } else {
      return new com.order.service.coreapi.events.product.ProductInventoryUpdatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProductInventoryUpdatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.order.service.coreapi.events.product.ProductInventoryUpdatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.order.service.coreapi.events.product.ProductInventoryUpdatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.inventoryCount)) {
        this.inventoryCount = data().deepCopy(fields()[0].schema(), other.inventoryCount);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.order.service.coreapi.events.product.ProductInventoryUpdatedEvent.Builder setInventoryCount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.order.service.coreapi.events.product.ProductInventoryUpdatedEvent.Builder clearInventoryCount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.order.service.coreapi.events.product.ProductInventoryUpdatedEvent.Builder setProductId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.order.service.coreapi.events.product.ProductInventoryUpdatedEvent.Builder clearProductId() {
      productId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.order.service.coreapi.events.product.ProductInventoryUpdatedEvent.Builder setUpdatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.order.service.coreapi.events.product.ProductInventoryUpdatedEvent.Builder clearUpdatedAt() {
      updatedAt = null;
